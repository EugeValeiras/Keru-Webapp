...
/**
 * KER-38 · UC-04 (NFR-41): el botón "Salir" hace logout REAL — la API deslista el jti y el
 * mismo token deja de valer al instante (no al expirar). Se prueba por la UI y se verifica
 * server-side pegándole a la API con el token capturado antes de salir.
 */
const run = Date.now();
